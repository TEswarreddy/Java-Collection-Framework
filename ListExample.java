...
public class ArrayListExample2
{
	public static void main(String[] args)
	{
		...
		System.out.println("list 1 elemnts are:"+list1);
		...
		list2.add(7);
		list2.add(8);
		System.out.println(" list2 elemnts are:"+list2);
		...
		System.out.println("Size of the list1:"+list1.size());
		System.out.println("The  list2 elements are there in  list1:"+list1.containsAll(list2));
	    ...
	    list2.clear();
		System.out.println("after clearing all elements in  list2:"+list2);
...
//OUTPUT:
/*
list 1 elemnts are:[1, 2, 3, 4]
Size of the  list1:4
 list2 elemnts are:[5, 6, 7, 8]
Size of the  list2:4
